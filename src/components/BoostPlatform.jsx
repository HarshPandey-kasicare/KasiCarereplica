...
import morefeatureImage4 from "../assets/images/morefeatures4.webp";
            ...
            <div className="p-6 lg:p-12">
              <div className="max-w-lg">
                <h2 className="text-3xl md:text-4xl font-bold text-red-800 mb-6">
                  Boost Conversion via Social Media
                </h2>

                <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">
                  Does your social media bio link opens a boring google form?
                </h3>

                <p className="text-gray-600 mb-8">
                  Design your website, or pick from our curated templates Create
                  beautiful service catalogs Link-in-bio for Instagram,
                  LinkedIn, and WhatsApp Custom domain Search Engine
                  Optimisation
                </p>
